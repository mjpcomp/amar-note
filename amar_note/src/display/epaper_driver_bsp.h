...
public:
    ...
    void EPD_DisplayPartTrigger();   /* start a partial update but DON'T wait for BUSY */
    bool EPD_IsBusy();               /* true while a refresh is in progress */
    void EPD_Sleep();   /* deep sleep the panel controller (image is retained) */
